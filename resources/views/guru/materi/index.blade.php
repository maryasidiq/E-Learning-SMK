        ...
        <div class="relative rounded-3xl p-8 sm:p-10 mb-8 overflow-hidden bg-white dark:bg-gray-800 shadow-xl border border-gray-100 dark:border-gray-700">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="animate-fade-in w-full md:w-2/3">
                    ...
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-2 text-gray-900 dark:text-white tracking-tight">Materi Mapel</h1>
                    <p class="text-gray-600 dark:text-gray-300 text-lg mb-6 max-w-2xl">Kelola materi pembelajaran Anda</p>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <div class="flex items-center bg-gray-50 dark:bg-gray-700/50 rounded-xl px-4 py-2.5 border border-gray-200 dark:border-gray-600 shadow-sm transition-transform hover:-translate-y-1 duration-300">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider">Total Materi</p>
                                <p class="text-sm font-bold text-gray-900 dark:text-white">{{ $materi->count() }} Materi Tersedia</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if($materiMapel->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-12">
                    @foreach($materiMapel as $index => $item)
                        <div class="group bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-100 dark:border-gray-700/50 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1 transition-all duration-300 overflow-hidden relative">
                            <!-- Gradient Border Effect -->
                            <div class="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-indigo-500/20 to-purple-500/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                            <!-- Card Header -->
                            <div class="relative bg-white dark:bg-gray-800 p-6 border-b border-gray-100 dark:border-gray-700/50">
                                <div class="relative flex justify-between items-start">
                                    <div class="flex items-start max-w-[80%]">
                                        <div class="w-12 h-12 bg-blue-50 dark:bg-blue-900/30 rounded-xl flex items-center justify-center mr-4 shadow-sm border border-blue-100 dark:border-blue-800 shrink-0">
                                            @if($item->tipe == 'teks')
                                        ...
                                        <div>
                                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2 leading-tight">{{ $item->judul }}</h3>
                                            @if($item->deskripsi)
                                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-600">
                                    ...
                                    <div class="flex items-center space-x-2 shrink-0">
                                        <div class="w-8 h-8 bg-gray-50 dark:bg-gray-700/50 rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-600">
                                            <span class="text-xs font-bold text-gray-500 dark:text-gray-400">{{ $no++ }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
relative overflow-hidden">
                                    ...
                                    <div class="flex gap-2">
                                        <a href="{{ route('materi.edit', Crypt::encrypt($item->id)) }}"
                                            class="flex-1 sm:flex-none inline-flex items-center justify-center px-4 py-2.5 bg-white dark:bg-gray-800 text-yellow-600 border border-yellow-200 dark:border-yellow-900/50 hover:bg-yellow-50 dark:hover:bg-yellow-900/30 rounded-xl font-bold text-sm transition-all duration-300 transform hover:-translate-y-0.5 shadow-sm hover:shadow-md relative overflow-hidden group">
                                        ...
                                        <form action="{{ route('materi.destroy', $item->id) }}" method="POST" class="flex-none">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="inline-flex items-center justify-center px-4 py-2.5 bg-white dark:bg-gray-800 text-red-600 border border-red-200 dark:border-red-900/50 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-xl font-bold text-sm transition-all duration-300 transform hover:-translate-y-0.5 shadow-sm hover:shadow-md relative overflow-hidden group"
            ...
            @else
                <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm mb-12 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <div class="mb-6 animate-bounce">
                            <div class="w-16 h-16 bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 rounded-full flex items-center justify-center mx-auto shadow-sm">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm max-w-md mx-auto leading-relaxed">Belum ada materi yang ditambahkan untuk mapel ini.</p>
                    </div>
                </div>
            @endif
        @empty
            <div class="text-center py-20 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-xl relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="mb-8 animate-bounce">
                        <div class="w-24 h-24 bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 rounded-full flex items-center justify-center mx-auto shadow-sm">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-lg max-w-md mx-auto leading-relaxed">Mulai dengan menambahkan materi pertama Anda.</p>
                <div class="mt-8 flex justify-center">
                    <a href="{{ route('materi.create') }}"
                        class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
