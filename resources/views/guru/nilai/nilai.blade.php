        ...
        <div class="relative rounded-3xl p-8 sm:p-10 mb-8 overflow-hidden bg-white dark:bg-gray-800 shadow-xl border border-gray-100 dark:border-gray-700">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div class="animate-fade-in">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-extrabold mb-2 text-gray-900 dark:text-white tracking-tight">Entry Nilai Siswa</h1>
                    <p class="text-gray-500 dark:text-gray-400 text-base mb-5">Kelola nilai akademik siswa dengan mudah dan efisien</p>
                ...
                <div class="hidden md:flex justify-end items-center relative">
                    <div class="relative w-28 h-28">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-tr from-blue-400 to-indigo-500 rounded-3xl -rotate-6 opacity-40 shadow-xl backdrop-blur-sm"></div>
        ...
        <div
            ...
            <div class="overflow-x-auto">
                <table id="nilai-table"
                    ...
                    <thead class="bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border-b-2 border-blue-200 dark:border-blue-700">
                        <tr>
                    ...
                    <tbody>
                        @foreach ($siswa as $s)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-200">
                                ...
                                <td
                                    class="px-6 py-4 border border-gray-200 dark:border-gray-700 rata-rata-{{ $s->id }}  font-bold text-[#2563eb]">
                                    0</td>
                                <td class="px-6 py-4 border border-gray-200 dark:border-gray-700 dark:text-white">
                                    <a href="{{ route('guru.nilai.edit', ['siswa_id' => $s->id, 'mapel_id' => $mapel->mapel_id]) }}"
                                        class="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-white rounded-lg bg-[#2563eb] shadow-theme-xs hover:bg-[#1d4ed8] dark:bg-[#4f46e5] dark:hover:bg-[#4338ca] transition-colors duration-200">
