...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Hero Header -->
        <div
            class="relative rounded-3xl p-8 sm:p-12 mb-10 overflow-hidden bg-white dark:bg-gray-800 shadow-xl border border-gray-100 dark:border-gray-700">
            <!-- Decorative blobs -->
            <div
                class="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-gradient-to-br from-blue-400/30 to-indigo-600/30 blur-3xl rounded-full">
            </div>
            <div
                class="absolute bottom-0 left-0 -mb-20 -ml-20 w-72 h-72 bg-gradient-to-tr from-cyan-400/20 to-blue-500/20 blur-3xl rounded-full">
            </div>

            <div class="relative z-10 text-center max-w-2xl mx-auto">
                <div
                    class="w-16 h-16 bg-blue-100 dark:bg-blue-900/50 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-sm border border-blue-200 dark:border-blue-800">
                ...
                <h1 class="text-4xl sm:text-5xl font-extrabold mb-3 text-gray-900 dark:text-white tracking-tight">Panduan
                    Pengguna</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-7 mb-10 shadow-lg border border-gray-100 dark:border-gray-700">
            <h2 class="text-xl font-bold mb-5 text-gray-900 dark:text-white flex items-center">
                <span
                    class="w-8 h-8 bg-blue-100 dark:bg-blue-900/50 rounded-lg flex items-center justify-center mr-3 text-blue-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-200 dark:border-gray-600">
                    <h3
                        class="font-semibold text-sm mb-3 text-blue-600 dark:text-blue-400 uppercase tracking-wider flex items-center">
                    ...
                    <ul class="space-y-1.5">
                        <li><a href="#pendahuluan"
                                class="text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center"><span
                                    class="w-1 h-1 rounded-full bg-blue-400 mr-2"></span>Pendahuluan</a></li>
                        <li><a href="#login"
                                class="text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center"><span
                                    class="w-1 h-1 rounded-full bg-blue-400 mr-2"></span>Cara Login</a></li>
                        <li><a href="#dashboard"
                                class="text-sm text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center"><span
                                    class="w-1 h-1 rounded-full bg-blue-400 mr-2"></span>Dashboard</a></li>
                    </ul>
                </div>
                @if(Auth::user()->role == 'Siswa')
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-200 dark:border-gray-600">
                        <h3
                            class="font-semibold text-sm mb-3 text-emerald-600 dark:text-emerald-400 uppercase tracking-wider flex items-center">
                            <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="space-y-1.5">
                            <li><a href="#siswa-jadwal"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-emerald-400 mr-2"></span>Melihat Jadwal</a></li>
                            <li><a href="#siswa-materi"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-emerald-400 mr-2"></span>Mengakses Materi</a></li>
                            <li><a href="#siswa-soal"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-emerald-400 mr-2"></span>Mengerjakan Soal</a></li>
                            <li><a href="#siswa-forum"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-emerald-400 mr-2"></span>Forum Diskusi</a></li>
                            <li><a href="#siswa-rapot"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-emerald-400 mr-2"></span>Melihat Nilai Akademik</a></li>
                        </ul>
                    </div>
                @endif
                @if(Auth::user()->role == 'Guru')
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-200 dark:border-gray-600">
                        <h3
                            class="font-semibold text-sm mb-3 text-purple-600 dark:text-purple-400 uppercase tracking-wider flex items-center">
                            <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="space-y-1.5">
                            <li><a href="#guru-materi"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-purple-400 mr-2"></span>Upload Materi</a></li>
                            <li><a href="#guru-soal"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-purple-400 mr-2"></span>Membuat Soal</a></li>
                            <li><a href="#guru-forum"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-purple-400 mr-2"></span>Forum Diskusi</a></li>
                            <li><a href="#guru-nilai"
                                    class="text-sm text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors flex items-center"><span
                                        class="w-1 h-1 rounded-full bg-purple-400 mr-2"></span>Input Nilai Akademik</a></li>
                        </ul>
                    </div>
                @endif
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-200 dark:border-gray-600">
                    <h3
                        class="font-semibold text-sm mb-3 text-orange-600 dark:text-orange-400 uppercase tracking-wider flex items-center">
                        <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <ul class="space-y-1.5">
                        <li><a href="#pengaturan"
                                class="text-sm text-gray-600 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400 transition-colors flex items-center"><span
                                    class="w-1 h-1 rounded-full bg-orange-400 mr-2"></span>Pengaturan Profil</a></li>
                        <li><a href="#bantuan"
                                class="text-sm text-gray-600 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400 transition-colors flex items-center"><span
                                    class="w-1 h-1 rounded-full bg-orange-400 mr-2"></span>Bantuan & Dukungan</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <section id="pendahuluan"
                class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700">
                ...
                <div class="p-7">
                    <h2 class="text-2xl font-bold mb-5 text-gray-900 dark:text-white flex items-center">
                        <span
                            class="w-8 h-8 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 flex items-center justify-center text-sm font-black mr-3">1</span>
                        Pendahuluan
                    </h2>
                    <div class="prose prose-lg dark:prose-invert max-w-none">
                        ...
                        <p>Sistem ini dibangun dengan teknologi modern untuk memastikan kemudahan penggunaan dan keamanan
                            data.
            ...
            <section id="login"
                ...
                <div class="p-7">
                    <h2 class="text-2xl font-bold mb-5 text-gray-900 dark:text-white flex items-center">
                        <span
                            class="w-8 h-8 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 flex items-center justify-center text-sm font-black mr-3">2</span>
                        Cara Login
                    </h2>
                    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                        <div class="lg:col-span-3">
                            <h3 class="text-base font-semibold mb-3 text-gray-800 dark:text-gray-200">Langkah-langkah Login:
                            </h3>
                            <ol class="space-y-2">
                                @foreach(['Buka browser dan akses alamat website sekolah', 'Klik tombol "Login" di halaman utama', 'Masukkan email dan password yang telah diberikan', 'Klik tombol "Masuk"', 'Anda akan diarahkan ke dashboard sesuai role Anda'] as $step => $text)
                                    <li class="flex items-start">
                                        <span
                                            class="w-6 h-6 rounded-full bg-blue-600 text-white text-xs font-bold flex items-center justify-center mr-3 mt-0.5 shrink-0">{{ $step + 1 }}</span>
                        ...
                        <div class="lg:col-span-2">
                            <div
                                class="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-5 border border-amber-100 dark:border-amber-800">
                                ...
                                <ul class="space-y-2 text-sm text-amber-700 dark:text-amber-300">
                                    <li class="flex items-start"><span class="mr-2">•</span>Pastikan menggunakan email yang
                                        valid</li>
                                    <li class="flex items-start"><span class="mr-2">•</span>Password bersifat case-sensitive
                                    </li>
                                    <li class="flex items-start"><span class="mr-2">•</span>Jika lupa password, hubungi
                                        administrator</li>
                                    <li class="flex items-start"><span class="mr-2">•</span>Sistem akan logout otomatis
                                        setelah 2 jam tidak aktif</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <section id="dashboard"
                ...
                <div class="p-7">
                    <h2 class="text-2xl font-bold mb-5 text-gray-900 dark:text-white flex items-center">
                        <span
                            class="w-8 h-8 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-600 flex items-center justify-center text-sm font-black mr-3">3</span>
                        Dashboard
                    </h2>
                    <p class="text-gray-600 dark:text-gray-300 mb-5">Dashboard adalah halaman utama setelah login yang
                        menampilkan informasi penting secara ringkas dan real-time.</p>
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        @foreach(['Jadwal pelajaran hari ini' => 'blue', 'Pengumuman sekolah' => 'emerald', 'Tanggal dan waktu real-time' => 'purple'] as $fitur => $color)
                            <div
                                class="flex items-center p-4 bg-{{ $color }}-50 dark:bg-{{ $color }}-900/20 rounded-xl border border-{{ $color }}-100 dark:border-{{ $color }}-800">
            ...
            @if(Auth::user()->role == 'Siswa')
                ...
                <section id="siswa-forum" class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
                    <h2 class="text-3xl font-bold mb-6 text-green-600 dark:text-green-400">Untuk Siswa - Forum Diskusi</h2>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            <h3 class="text-xl font-semibold mb-4">Cara Mengakses Forum Diskusi:</h3>
                            <ol class="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-300">
                                <li>Klik menu "Forum" di sidebar</li>
                                <li>Pilih "Forum Siswa"</li>
                                <li>Lihat daftar topik diskusi yang tersedia</li>
                                <li>Klik judul topik untuk melihat detail diskusi</li>
                                <li>Tambahkan komentar atau pendapat Anda</li>
                                <li>Balas komentar siswa lain jika ingin merespons</li>
                            </ol>
                        </div>
                        <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                            <p class="text-sm text-green-700 dark:text-green-300">Forum diskusi digunakan untuk berdiskusi
                                tentang materi pembelajaran. Anda dapat membaca topik yang dibuat oleh guru dan berpartisipasi
                                dalam diskusi dengan memberikan komentar.</p>
                        </div>
                    </div>
                </section>
            ...
            @if(Auth::user()->role == 'Guru')
                ...
                <section id="guru-forum" class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
                    <h2 class="text-3xl font-bold mb-6 text-purple-600 dark:text-purple-400">Untuk Guru - Forum Diskusi</h2>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            <h3 class="text-xl font-semibold mb-4">Cara Mengelola Forum Diskusi:</h3>
                            <ol class="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-300">
                                <li>Klik menu "Forum" di sidebar</li>
                                <li>Pilih "Forum Guru"</li>
                                <li>Untuk membuat topik baru: Klik "Buat Topik Baru"</li>
                                <li>Isi judul topik, pilih mata pelajaran, dan tambahkan deskripsi</li>
                                <li>Klik "Simpan" untuk mempublikasikan topik</li>
                                <li>Untuk menutup topik: Klik tombol "Tutup" pada topik tertentu</li>
                                <li>Untuk membuka kembali topik: Klik tombol "Buka Kembali"</li>
                                <li>Untuk menghapus topik: Klik tombol "Hapus" (dengan konfirmasi)</li>
                            </ol>
                        </div>
                        <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
                            <p class="text-sm text-purple-700 dark:text-purple-300">Forum diskusi digunakan untuk memfasilitasi
                                diskusi antara guru dan siswa. Anda dapat membuat topik diskusi baru, mengelola komentar,
                                menutup atau membuka kembali topik yang sudah tidak aktif, serta menghapus topik yang tidak
                                diperlukan.</p>
                        </div>
                    </div>
                </section>
            ...
            <section id="pengaturan"
                ...
                <div class="p-7">
                    <h2 class="text-2xl font-bold mb-5 text-gray-900 dark:text-white flex items-center">
                        <span
                            class="w-8 h-8 rounded-lg bg-orange-100 dark:bg-orange-900/50 text-orange-600 flex items-center justify-center mr-3">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z">
                                </path>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div
                            ...
                            <ol class="space-y-2">
                                @foreach(['Klik menu "Profile" di sidebar', 'Pilih "Pengaturan Profile"', 'Edit data pribadi (nama, email, dll)', 'Upload foto profil baru', 'Klik "Ubah Profile" untuk menyimpan'] as $step => $text)
                                    <li class="flex items-start">
                                        <span
                                            class="w-5 h-5 rounded-full bg-orange-400 text-white text-xs font-bold flex items-center justify-center mr-2.5 mt-0.5 shrink-0">{{ $step + 1 }}</span>
                                        <span class="text-gray-600 dark:text-gray-300 text-sm">{{ $text }}</span>
                                    </li>
                                @endforeach
                            </ol>
                        ...
                        <div
                            class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-5 border border-gray-200 dark:border-gray-600">
                            <h3 class="text-base font-semibold mb-3 text-gray-800 dark:text-gray-200">Mengubah Password:
                            </h3>
                            <ol class="space-y-2">
            ...
            <section id="bantuan"
                ...
                <div class="p-7">
                    <h2 class="text-2xl font-bold mb-5 text-gray-900 dark:text-white flex items-center">
                        <span
                            class="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 flex items-center justify-center mr-3">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 class="text-base font-semibold mb-4 text-blue-600 dark:text-blue-400">Jika Mengalami
                                Masalah:</h3>
                            <ul class="space-y-2.5">
                                @foreach(['Cek koneksi internet', 'Refresh halaman browser', 'Clear cache browser', 'Gunakan browser terbaru (Chrome, Firefox, Edge)', 'Logout dan login kembali'] as $item)
                                    <li class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                        <span
                                            class="w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-600 text-xs flex items-center justify-center mr-3 shrink-0">✓</span>
                                        {{ $item }}
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        <div>
                            <h3 class="text-base font-semibold mb-4 text-emerald-600 dark:text-emerald-400">Kontak Dukungan:
                            </h3>
                            <div
                                class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-5 border border-gray-200 dark:border-gray-600">
        ...
        <div class="mt-10 text-center">
            <div
                class="relative bg-white dark:bg-gray-800 rounded-3xl p-8 overflow-hidden shadow-xl border border-gray-100 dark:border-gray-700">
                <div
                    class="absolute inset-0 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10">
                </div>
                <div class="relative z-10">
                    <div
                        class="w-12 h-12 bg-blue-100 dark:bg-blue-900/50 rounded-xl flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Panduan ini dibuat untuk memudahkan penggunaan sistem
                        e-learning. Semoga bermanfaat!</p>
                </div>
            </div>
        </div>
    </div>
