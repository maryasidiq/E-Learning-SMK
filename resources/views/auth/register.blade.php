...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))"
                        ...
                        <form action="{{ route('register') }}" method="post">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    @error('email')
                                        <span class="text-sm text-error-500 font-thin" role="alert">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="role" name="role" value="{{ old('role') }}" autocomplete="role"
                                        class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 @error('role') is-invalid @enderror">
                                ...
                                <div class="mb-3" id="noId">
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        No Induk<span class="text-error-500">*</span>
                                    </label>
                                    <input id="nomer" type="text" placeholder="No Induk Siswa" name="nomer"
                                        value="{{ old('nomer') }}" autocomplete="nomer"
    ...
    <script>
        ...
        noId.style.display = role.value === '' ? 'none' : 'block';
        ...
        role.addEventListener('change', function () {
            if (role.value !== '') {
                ...
                if (role.value === 'Siswa') {
                    nomer.value = '';
                    nomer.placeholder = 'No Induk Siswa';
                } else if (role.value === 'Guru') {
                    nomer.value = '';
                    nomer.placeholder = 'No Id Card';
                    nomer.maxLength = 5;
                }
            }
        });
